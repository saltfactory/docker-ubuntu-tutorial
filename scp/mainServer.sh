...
DOCKER_CONTAINER_NAME="demo-mainServer"
...
function build_image {
  docker build -f Dockerfile-mainServer -t $DOCKER_IMAGE .
}
...
function start_container {
  ...
  docker run --name $DOCKER_CONTAINER_NAME -h mainServer  -it $DOCKER_IMAGE bash
}
