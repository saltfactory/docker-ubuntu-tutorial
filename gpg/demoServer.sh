...
############################################################
## docker project name
PROJECT_NAME="demo-gpg"
############################################################
## docker configurations
DOCKER_USER="saltfactory"
DOCKER_TAG="mainserver"
DOCKER_NAME="demo_gpg"
DOCKER_IMAGE="$DOCKER_USER/$DOCKER_NAME:$DOCKER_TAG"
############################################################
## container configurations
DOCKER_CONTAINER_NAME="demo-server"
DOCKER_CONTAINER_HOSTNAME="demo-server"
...
function start_container {
  ...
  docker run --name $DOCKER_CONTAINER_NAME -h $DOCKER_CONTAINER_HOSTNAME  -it $DOCKER_IMAGE bash
}
